...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mer. 01 oct. 2025 à 08:39
...
INSERT INTO `cheval` (`id`, `nom`, `dateNaissance`, `race_id`, `code_sire`, `taille`, `poids`, `robe_id`, `pere_id`, `mere_id`) VALUES
(1, 'Eclipse', '2017-03-12', 4, '0808.001.001Z', 168, 520.00, 1, 1, 13),
...
INSERT INTO `course` (`id`, `nom`, `dateCourse`) VALUES
(1, 'Chavelier', '2022-06-20'),
(2, 'Des chevals', '2019-07-30');
...
--
ALTER TABLE `lot`
  ADD CONSTRAINT `fk_cheval_lot` FOREIGN KEY (`cheval_id`) REFERENCES `cheval` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
